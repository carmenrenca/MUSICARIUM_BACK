...
router.get('/getPedidoId/:id', PedidoController.getPedidoId);
router.put('/updateStatus/:id', PedidoController.changeStatus);
router.post('/crearpdf/:idpedido', PedidoController.createPDF);
router.get('/getpdf/:id', PedidoController.getPDF);
router.get('/getAllpedido/:status?', PedidoController.getAllPedidos);
router.get('/getPedidoCliente/:email', PedidoController.getPedidoCliente);
router.post('/save', ArticleMongo.save );
router.get('/search/:search', ArticleMongo.search);
